...
public class GameWindow extends AbstractWindow{
    ...
    //Cursors
    private static final Image grabCursorImage = Toolkit.getDefaultToolkit().getImage("RummyClient/graphics/icon_grab_white.png");
    ...
    private static final Image cardsCursorImage = Toolkit.getDefaultToolkit().getImage("RummyClient/graphics/icon_card_white.png");
    ...
    private void initializeLogicArraysWithExemplaryData(){
        ...
        ImageIcon userImage = new ImageIcon(new ImageIcon("RummyClient/graphics/user.png").getImage().getScaledInstance(25,25, Image.SCALE_SMOOTH));
